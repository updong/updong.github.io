...
BLOG_AUTHOR = "Keunwoo Ryu"  # (translatable)
BLOG_TITLE = "Keunwoo Ryu"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://updong.net/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://updong.net/"
BLOG_EMAIL = "updong@updong.net"
BLOG_DESCRIPTION = "Digital Wannabe"  # (translatable)
